(function () {
    function init(root) {
        if (!root) return;
        var track = root.querySelector('.bkbg-ts-carousel-track');
        if (!track) return;
        ...
        var progressBar = root.querySelector('.bkbg-ts-progress-bar');
        ...
        function getSlides() {
            return track.querySelectorAll('.bkbg-ts-slide');
        }
        ...
        var prev = root.querySelector('[data-bkbg-nav="prev"], [data-ts-nav="prev"]');
        var next = root.querySelector('[data-bkbg-nav="next"], [data-ts-nav="next"]');
    ...
    function boot() {
        var blocks = document.querySelectorAll('.wp-block-blockenberg-testimonials');
